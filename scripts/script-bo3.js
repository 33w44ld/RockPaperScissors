...
function akt(ktr_przycisk)
{
    if(ktr_przycisk==0)
    {
        ...
        komunikat="Wybrałeś tryb *Najlepszy z pięciu*. Wygrywa ten, który wygra 2 rundy. Powodzenia!!!";
    ...
    else 
    {
        ...
        {
            komunikat="Remis! Wybraliście "+nazwy_wybor[wybor_gracz-1]+" Nikt nie wygrywa";
        ...
        ((wybor_gracz==3) && (wybor_komputer==2)))
        {
            ...
            if(pkt_gracz==3) 
            {
                komunikat="Wygrałeś *Najlepszy z pięciu*. Wygrałeś 3 rundy. Wynik to "+pkt_gracz+":"+pkt_komputer;
                kolor_komunikatu="#03a1fc"
                liczba_gier=0;
                pkt_gracz=0;
                pkt_komputer=0;
                document.getElementById("przy1").style.background="black";
            ...
            {
                komunikat="Wygrałeś runde!!! Wybrałeś "+nazwy_wybor[wybor_gracz-1]+"a komputer wybrał "+nazwy_wybor[wybor_komputer-1];
        ...
        ((wybor_gracz==3) && (wybor_komputer==1)))
        {
            ...
            if(pkt_komputer==3) 
            {
                komunikat="Przegrałeś *Najlepszy z pięciu*. Komputer wygrał 3 rundy. Wynik to "+pkt_gracz+":"+pkt_komputer;
                kolor_komunikatu="#eb34de"
                liczba_gier=0;
                pkt_gracz=0;
                pkt_komputer=0;
                document.getElementById("przy1").style.background="black";
            ...
            {
                komunikat="Przegrałeś runde!!! Wybrałeś "+nazwy_wybor[wybor_gracz-1]+"a komputer wybrał "+nazwy_wybor[wybor_komputer-1];
